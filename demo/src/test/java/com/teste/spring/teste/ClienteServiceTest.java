...
class ClienteServiceTest {
    ...
    // 🔥 NOVO TESTE — cobre o último branch do ClienteService
    @Test
    void atualizar_devePermitirQuandoEmailNaoExisteAinda() {
        Cliente antigo = new Cliente();
        antigo.setId(1L);
        antigo.setNome("Antigo");
        antigo.setEmail("antigo@ex.com");
        antigo.setTelefone("11");
        ...
        // AQUI está o branch que faltava → existsByEmail = false
        ...
        // Garante que findByEmail NÃO é chamado, devido ao curto-circuito do &&
        verify(repo, never()).findByEmail("novo@ex.com");
    }
